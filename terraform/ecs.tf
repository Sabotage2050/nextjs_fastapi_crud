...
locals {
  ecr_frontend_repository_name           = "fastapi-nextjs-crud-todo-next"
  ecr_backend_middleware_repository_name = "fastapi-nextjs-crud-todo-backend-nginx"
  ecr_backend_app_repository_name        = "fastapi-nextjs-crud-todo-backend-fastapi"
}
#todo refactor
